...
class BasicConnectionPoolTest {
    ...
    static void setUp() {
        ...
        basicConnectionPool = new BasicConnectionPool(com.mysql.cj.jdbc.Driver.class.getName(),"jdbc:mysql://133.186.241.167:3306/nhn_academy_25","nhn_academy_25","[Rzpkf5FOAuO-t5j",5);
//        connection = DriverManager.getConnection("jdbc:mysql://133.186.241.167:3306/nhn_academy_25","nhn_academy_25","[Rzpkf5FOAuO-t5j");
    }
